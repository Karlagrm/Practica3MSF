"""
Práctica 3: Sistema muscoesquelético
...
fg1.tight_layout()
fg1.savefig('sistema musculoesqueletico_ Lazo abierto pyhton.png', dpi=600,bbox_inches='tight')
fg1.savefig('sistema musculoesqueletico_Lazo abierto pyhton.pdf')
...
fg2.tight_layout()
fg2.savefig('sistema musculoesqueletico_Lazo cerrado pyhton.png', dpi=600,bbox_inches='tight')
fg2.savefig('sistema musculoesqueletico_Lazo cerrado pyhton.pdf')
